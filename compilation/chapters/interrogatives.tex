...
Polar questions are formed in Ishiculu with the polar question particle \textit{\textipa{le}} at the end of the sentence.
...
Ishiculu uses particles \textit{\textipa{yebo}}, `yes' and \textit{\textipa{cha}}, `no' to respond to polar questions. Ishiculu's response strategy is also truth-based; that is, \textit{\textipa{cha}} confirms a negative question, and \textit{\textipa{yebo}} contradicts the negation of a negative question.
...
\begin{exe}
\ex
\gll {W\textramshorns} babamama ba-ka-u-nde-\textipa{\textbeltl}a-mbi uba shizi le? \\
...
\ex
\gll {W\textramshorns} babamama ba-uw-u-nde-\textipa{\textbeltl}a-mbi uni wena le? \\
...
\ex
\gll {W\textramshorns} babamama ba-uw-u-nde-\textipa{\textbeltl}a-mbi una wena shizi le? \\
